            ...
            <div class="col-xs-2 sidebar">
                ...
                <ul class="nav nav-sidebar">
                    <li class="leftBtn"><a href="javascript:void(0)" onclick="selectModule(1)"><span class="icon-color glyphicon glyphicon-list-alt"></span>&nbsp;&nbsp;订单管理</span><!--<span class="badge">9999</span>--></a></li><!--订水老板版-->
                                        <li class="leftBtn"><a href="javascript:void(0)" onclick="selectModule(2)"><span class="icon-color glyphicon glyphicon-piggy-bank"></span>&nbsp;&nbsp;预定记录</a></li>
                                        <li class="leftBtn"><a href="javascript:void(0)" onclick="selectModule(3)"><span class="icon-color glyphicon glyphicon-repeat"></span>&nbsp;&nbsp;空桶管理</a></li>
                    <li class="leftBtn"><a href="javascript:void(0)" onclick="selectModule(4)"><span class="icon-color glyphicon glyphicon-user"></span>&nbsp;&nbsp;用户管理</a></li>
                </ul>
                <ul class="nav nav-sidebar">
                    ...
                    <li class="leftBtn"><a href="javascript:void(0)" onclick="selectModule(6)"><span class="icon-color glyphicon glyphicon-envelope"></span>&nbsp;&nbsp;反馈信息</span></a></li>
                </ul>
            </div>
        </div>
