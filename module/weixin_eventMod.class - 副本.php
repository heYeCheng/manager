<?php
require_once('./module/userMod.class.php');
// $uu = new userMod();
// $uu->weixin_subscribe('opF2vs-xOBcNalRopNKeeNns07Rc', 1, '1');

define("TOKEN", "weixin");
$wechatObj = new weixin_eventMod();
...
class weixin_eventMod extends commonMod{
    //验证签名
